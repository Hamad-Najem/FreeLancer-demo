...
/* $addUser = "
INSERT INTO `users`(`user_id`, `user_name`, `user_pass`, `group_id`) 
VALUES (NULL,'$usName','$usPass','$userRole')
";
*/
...
?>
        ...
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="#page-top">Demo FreeLncer</a>
    ...
    modal.style.display = "none";
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <!-- Masthead Heading-->
                <h1 class="masthead-heading text-uppercase mb-0">Start FreeLncing</h1>
                <!-- Icon Divider-->
